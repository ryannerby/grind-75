...
console.log(medianFinder2.addNum(1)); // null
console.log(medianFinder2.findMedian()); // 1.0
console.log(medianFinder2.addNum(2)); // null
console.log(medianFinder2.addNum(3)); // null
console.log(medianFinder2.findMedian()); // 2.0