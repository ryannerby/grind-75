...
console.log(ladderLength("hit", "hot", ["hot","dot","dog","lot","log","cog"])); // Expected: 2
console.log(ladderLength("a", "c", ["a","b","c"])); // Expected: 2
console.log(ladderLength("hot", "dog", ["hot","dog"])); // Expected: 0
console.log(ladderLength("hot", "dog", ["hot","dog","dot"])); // Expected: 3