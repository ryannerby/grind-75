 ...
 * Time range [1-3] and [3-6] , we get profit of 120 = 50 + 70.
 * 
 * Example 2:
...
console.log(jobScheduling([1,2,3], [3,4,5], [10,20,30])); // Expected: 50
console.log(jobScheduling([1,2,3,4], [2,3,4,5], [10,20,30,40])); // Expected: 100